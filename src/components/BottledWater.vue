  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title pull-left">Bottled Water List</h4>
...
export default {
  ...
  data () {
    return {
      data: [
        {
          name: 'SRS BOTTLED WATER 500 ML',
          uom: '500 ML',
          inventory: '1000'
        },
        {
          name: 'SRS BOTTLED WATER 250 ML',
          uom: '250 ML',
          inventory: '1000'
        },
        {
          name: 'SRS BOTTLED WATER 300 ML',
          uom: '300 ML',
          inventory: '1000'
        }
      ],
